describe('hashTable', function() {
  ...
  it('should know when to double in size', function() {
    for (var i = 0; i < 100; i++) {
    hashTable.insert('Steven'+[i], 'Tyler'+[i]);
    hashTable.insert('Steven1'+[i], 'Tyler1'+[i]);
    hashTable.insert('Steven2'+[i], 'Tyler2'+[i]);
    hashTable.insert('Steven3'+[i], 'Tyler3'+[i]);
    hashTable.insert('Steven4'+[i], 'Tyler4'+[i]);
    }               
